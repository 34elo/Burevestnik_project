...
"")
        ...
        self.pushButton_education1us.setIcon(icon2)
...
"}")
        ...
        self.pushButton_education2us = QtWidgets.QPushButton(parent=self.widget_5)
        icon4 = QtGui.QIcon()
        icon4.addPixmap(QtGui.QPixmap(os.path.abspath("res/groups_24dp_FFFFFF_FILL0_wght400_GRAD0_opsz24.png"), QtGui.QIcon.Mode.Normal, QtGui.QIcon.State.Off))
        icon4.addPixmap(QtGui.QPixmap(os.path.abspath("res/groups_24dp_005500_FILL0_wght400_GRAD0_opsz24.png"), QtGui.QIcon.Mode.Normal, QtGui.QIcon.State.On))
        self.pushButton_education2us.setIcon(icon4)
        self.pushButton_education2us.setCheckable(True)
        self.pushButton_education2us.setAutoExclusive(True)
        self.pushButton_education2us.setObjectName("pushButton_education2us")
        self.verticalLayout_2.addWidget(self.pushButton_education2us)
...
"")
        ...
        icon5 = QtGui.QIcon()
        icon5.addPixmap(QtGui.QPixmap(os.path.abspath("res/menu_24dp_FFFFFF_FILL0_wght400_GRAD0_opsz24.png"), QtGui.QIcon.Mode.Normal, QtGui.QIcon.State.Off))
        ...
        icon6 = QtGui.QIcon()
        icon6.addPixmap(QtGui.QPixmap(os.path.abspath("res/remove_24dp_FFFFFF_FILL0_wght400_GRAD0_opsz24.png"), QtGui.QIcon.Mode.Normal, QtGui.QIcon.State.Off))
        ...
        icon7 = QtGui.QIcon()
        icon7.addPixmap(QtGui.QPixmap(os.path.abspath("res/check_box_outline_blank_24dp_FFFFFF_FILL0_wght400_GRAD0_opsz24.png"), QtGui.QIcon.Mode.Normal, QtGui.QIcon.State.Off))
        ...
        self.pushButton_graph = QtWidgets.QPushButton(parent=self.layoutWidget)
...
"}")
        ...
        self.pushButton_report_2 = QtWidgets.QPushButton(parent=self.layoutWidget)
...
"}")
        ...
        self.horizontalLayout_9.addWidget(self.pushButton_report_2)
...
"}")
        ...
        self.scrollAreaWidgetContents.setGeometry(QtCore.QRect(0, 0, 877, 295))
        ...
        self.scrollAreaWidgetContents_2.setGeometry(QtCore.QRect(0, 0, 877, 296))
...
"}")
        ...
        self.pushButton_education2us.toggled['bool'].connect(self.pushButton_education1us.setChecked) # type: ignore
        self.pushButton_education1us.toggled['bool'].connect(self.pushButton_education2us.setChecked) # type: ignore
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.pushButton_education2us.setText(_translate("MainWindow", "Бригады"))
