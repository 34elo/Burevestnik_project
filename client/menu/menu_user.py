...
"")
        ...
        icon = QtGui.QIcon()
        icon.addPixmap(QtGui.QPixmap(os.path.abspath("res/menu_24dp_FFFFFF_FILL0_wght400_GRAD0_opsz24.png")), QtGui.QIcon.Mode.Normal, QtGui.QIcon.State.Off)
        ...
        icon1 = QtGui.QIcon()
        icon1.addPixmap(QtGui.QPixmap(os.path.abspath("res/remove_24dp_FFFFFF_FILL0_wght400_GRAD0_opsz24.png")), QtGui.QIcon.Mode.Normal, QtGui.QIcon.State.Off)
        ...
        icon2 = QtGui.QIcon()
        icon2.addPixmap(QtGui.QPixmap(os.path.abspath("res/check_box_outline_blank_24dp_FFFFFF_FILL0_wght400_GRAD0_opsz24.png")), QtGui.QIcon.Mode.Normal, QtGui.QIcon.State.Off)
        ...
        icon3 = QtGui.QIcon()
        icon3.addPixmap(QtGui.QPixmap(os.path.abspath("res/close_24dp_FFFFFF_FILL0_wght400_GRAD0_opsz24.png")), QtGui.QIcon.Mode.Normal, QtGui.QIcon.State.Off)
...
"")
        ...
        icon4 = QtGui.QIcon()
        icon4.addPixmap(QtGui.QPixmap(os.path.abspath("res/add_24dp_FFFFFF_FILL0_wght400_GRAD0_opsz24.png")), QtGui.QIcon.Mode.Normal, QtGui.QIcon.State.Off)
        icon4.addPixmap(QtGui.QPixmap(os.path.abspath("res/add_24dp_005500_FILL0_wght400_GRAD0_opsz24.png")), QtGui.QIcon.Mode.Normal, QtGui.QIcon.State.On)
        self.pushButton_acc1_us.setIcon(icon4)
        ...
        icon5 = QtGui.QIcon()
        icon5.addPixmap(QtGui.QPixmap(os.path.abspath("res/school_24dp_FFFFFF_FILL0_wght400_GRAD0_opsz24.png")), QtGui.QIcon.Mode.Normal, QtGui.QIcon.State.Off)
        icon5.addPixmap(QtGui.QPixmap(os.path.abspath("res/school_24dp_005500_FILL0_wght400_GRAD0_opsz24.png")), QtGui.QIcon.Mode.Normal, QtGui.QIcon.State.On)
        self.pushButton_education1us.setIcon(icon5)
        ...
        icon6 = QtGui.QIcon()
        icon6.addPixmap(QtGui.QPixmap(os.path.abspath("res/summarize_24dp_FFFFFF_FILL0_wght400_GRAD0_opsz24.png")), QtGui.QIcon.Mode.Normal, QtGui.QIcon.State.Off)
        icon6.addPixmap(QtGui.QPixmap(os.path.abspath("res/summarize_24dp_005500_FILL0_wght400_GRAD0_opsz24.png")), QtGui.QIcon.Mode.Normal, QtGui.QIcon.State.On)
        self.pushButton_orde1_2.setIcon(icon6)
        ...
        spacerItem2 = QtWidgets.QSpacerItem(20, 278, QtWidgets.QSizePolicy.Policy.Minimum, QtWidgets.QSizePolicy.Policy.Expanding)
        self.verticalLayout_4.addItem(spacerItem2)
        self.pushButton_logout1 = QtWidgets.QPushButton(parent=self.widget_4)
        self.pushButton_logout1.setText("")
        icon7 = QtGui.QIcon()
        icon7.addPixmap(QtGui.QPixmap(os.path.abspath("res/logout_24dp_FFFFFF_FILL0_wght400_GRAD0_opsz24.png")), QtGui.QIcon.Mode.Normal, QtGui.QIcon.State.Off)
        icon7.addPixmap(QtGui.QPixmap(os.path.abspath("res/logout_24dp_005500_FILL0_wght400_GRAD0_opsz24.png")), QtGui.QIcon.Mode.Normal, QtGui.QIcon.State.On)
...
"}")
        ...
        self.pushButton_acc2_us.setIcon(icon4)
        ...
        self.pushButton_education2_us.setIcon(icon5)
        ...
        self.pushButton_order2_2.setIcon(icon6)
...
"}")
        ...
        self.label_8.setPixmap(QtGui.QPixmap(os.path.abspath("res/kisspng-user-profile-2018-in-sight-user-conference-expo-5b554c0968c377.0307553315323166814291-fotor-bg-remover-20241102121640.png")))
...
"color: white;")
        ...
        self.lineEdit_id_input.setGeometry(QtCore.QRect(30, 30, 261, 30))
...
"    color: white;")
        ...
        self.label_35.setGeometry(QtCore.QRect(30, 70, 661, 31))
        font = QtGui.QFont()
        font.setPointSize(16)
